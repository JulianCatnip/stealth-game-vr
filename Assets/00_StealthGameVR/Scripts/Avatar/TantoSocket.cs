...
public class TantoSocket : XRSocketInteractor
{
    ...
    {
        return base.CanHover(interactable) && interactable.CompareTag("Tanto"); // nur Steine gehören in diesen Sockel
    }

    public override bool CanSelect(XRBaseInteractable interactable)
    {
        return base.CanSelect(interactable) && interactable.CompareTag("Tanto"); // nur Steine gehören in diesen Sockel
    }
