...
public class KunaiSocket : XRSocketInteractor
{
    ...
    {
        return base.CanHover(interactable) && interactable.CompareTag("Kunai"); // nur Steine gehören in diesen Sockel
    }

    public override bool CanSelect(XRBaseInteractable interactable)
    {
        return base.CanSelect(interactable) && interactable.CompareTag("Kunai"); // nur Steine gehören in diesen Sockel
    }
